...
class CreateEmployee extends Component {
    ...
    componentDidMount() {
        if (this.props.match.params.empNo !== '_add') {
            EmployeeService.getEmployeeByEmpNo(this.props.match.params.empNo)
                .then((res) => {
    ...
    saveOrUpdateEmployee(e) {
        ...
        if (this.props.match.params.empNo === '_add') {
            ...
            EmployeeService.updateEmployee(employee, this.props.match.params.empNo)
                .then((res) => {
                    this.props.history.push('/employees');
                })
                .catch((error) => {
    ...
    getTitle() {
        return this.props.match.params.empNo === '_add' ? <h3 className="text-center">Add Employee</h3> : <h3 className="text-center">Update Employee</h3>;
    }
